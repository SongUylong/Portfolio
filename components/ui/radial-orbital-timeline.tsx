          ...
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 bg-background/90 backdrop-blur-lg border-primary/30 shadow-xl shadow-primary/10 overflow-visible">
                            ...
                            {item.relatedIds.map((relatedId) => {
                              ...
                              return (
                                <Button
                                  ...
                                  variant="outline"
                                  size="sm"
                                  className="flex items-center h-6 px-2 py-0 text-xs rounded-none border-primary/20 bg-transparent hover:bg-primary/10 text-muted-foreground hover:text-primary transition-all"
                                  onClick={(e) => {
                                    e.stopPropagation();
